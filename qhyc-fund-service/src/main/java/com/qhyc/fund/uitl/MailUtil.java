...
public class MailUtil {
	...
	private static final String NOTIFY_MESSAGE = "有新用户注册，注册用户姓名为：%S 手机号 : %S";
	...
	public static void sendEmail(String fullName,String phone) throws Exception
    {

        Map<String,String> map= new HashMap<String,String>();
        MailUtil mail = new MailUtil("83831971@qq.com","gpjxzuogpkaibjcc");
        ...
        mail.setFrom("New Register");
        mail.setContent(String.format(NOTIFY_MESSAGE, fullName, phone), "text/html; charset=UTF-8");
